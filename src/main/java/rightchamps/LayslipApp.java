...
public class LayslipApp {

    private static final Logger log = LoggerFactory.getLogger(LayslipApp.class);

    private final Environment env;

    public LayslipApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LayslipApp.class);
