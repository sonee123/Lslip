...
describe('Service Tests', () => {
    ...
    describe('LayslipGridDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LayslipGridDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/layslip-grid-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LayslipGridDetails', () => {
