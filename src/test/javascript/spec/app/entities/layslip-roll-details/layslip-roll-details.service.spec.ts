...
describe('Service Tests', () => {
    ...
    describe('LayslipRollDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LayslipRollDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/layslip-roll-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LayslipRollDetails', () => {
